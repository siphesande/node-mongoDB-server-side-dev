...
function ItemDAO(database) {
        ...
        */
        ...
        toArray(function(err, categories) {
            ...
            categories.forEach(function(category) {
                categoryAll.num = categoryAll.num + category.num;
            });
    ...
    this.getItems = function(category, page, itemsPerPage, callback) {
        ...
        database.collection("item").find(filter).skip(page * itemsPerPage).limit(itemsPerPage).
    ...
    this.getNumSearchItems = function(query, callback) {
        ...
        */
        ...
        database.collection("item").count({$text : {$search : query}}, function(err, count) {
    ...
    this.getItem = function(itemId, callback) {
         ...
         */
         ...
         database.collection("item").findOne({_id : itemId}, function(err, item) {
    ...
    this.addReview = function(itemId, comment, name, stars, callback) {
        ...
        database.collection("item").updateOne({_id : itemId}, {$push : {reviews : reviewDoc}}, function(err, result) {
