...
function CartDAO(database) {
    ...
    this.getCart = function(userId, callback) {
        ...
        */
        ...
        database.collection("cart").findOne({userId : userId}, function(err, cart) {
    ...
    this.itemInCart = function(userId, itemId, callback) {
        ...
        database.collection("cart").findOne(
            {userId : userId, "items._id" : itemId}, {"items.$" : 1},
            function(err, result) {
    ...
    this.updateQuantity = function(userId, itemId, quantity, callback) {
        ...
        */
        ...
        if(quantity == 0) {
            ...
            database.collection("cart").findAndModify(
                {userId : userId},
                {},
