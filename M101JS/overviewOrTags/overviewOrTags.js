...
function queryDocument(options) {
    ...
    if ("overview" in options) {
     ...
     //query[{$or:[{"overview": {$exists:true}}, {"tag_list":{$exists:true}}]}] = {"$regex": options.overview, "$options": "i"};

     // query[{$or:[{"overview": {$exists:true}}, {"tag_list":{$exists:true}}]}] = {
     //                                                                             "$or":[
     //                                                                             {"$regex": options.overview, "$options": "i"}
     //                                                                             {"$regex": options.tag_list, "$options": "i"}
     //                                                                             ]
     //  
     //query[{$or:[{"overview": {$exists:true}}, {"tag_list":{$exists:true}}]}] = {"$regex": options.overview, "$options": "i"};
     query["$or"] = [
